...
import { Parents } from "../../../Class/Class"
import { SignIn } from "../../../Redux/Reducer/ParentReducer"
import HeaderAdmin from "../Header/HeaderAdmin"

const SignInParent = () => {
    const [parent,setParent] = useState(new Parents())
    const dispatch = useDispatch()
    const navigate = useNavigate()
    const Redirect = async() => {
        let result = await dispatch(SignIn(parent))
  ...
  return (
    <div>
        ...
        <div className="row g-3">
            ...
            <div className="col-md-6">
                <label className="form-label"></label>
                <input type="text" className="form-control" id="inputProfession" name="profession" placeholder="Profession " onChange={onChange}/>
            </div>
