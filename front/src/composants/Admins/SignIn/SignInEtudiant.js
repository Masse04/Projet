...
import { Etudiants } from '../../../Class/Class'
import {useDispatch} from 'react-redux'
import { SignIn } from '../../../Redux/Reducer/EtudiantReducer'
import HeaderAdmin from '../Header/HeaderAdmin'
import { useNavigate } from 'react-router-dom'

const SignInEtudiant = () => {
    const [etudiant,setEtudiant] = useState(new Etudiants())
    const dispatch = useDispatch()
    const navigate = useNavigate()
    const Redirect = async() => {
        let result = await dispatch(SignIn(etudiant))
  ...
  return (
    <div>
        ...
        <div className="row g-3">
            ...
            <div className="col-md-6">
                <label className="form-label"></label>
                <input type="text" className="form-control" id="inputClasse" name='classe' placeholder="Classe" onChange={onChange}/>
            </div>
            ...
            <div className="col-md-6">
                <label className="form-label"></label>
                <input type="text" className="form-control" id="inputCinParent" name='cinParent' placeholder="CIN de ton Parent " onChange={onChange}/>
            </div>
            <div className="col-md-6">
                <label className="form-label"></label>
